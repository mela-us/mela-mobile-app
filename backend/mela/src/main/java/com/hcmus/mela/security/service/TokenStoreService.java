...
//        redisTemplate.opsForValue().set("access_token:" + token, "blacklisted", Duration.ofSeconds(expirationSeconds));
//    }
//
//    // Store the refresh token
//    public void storeRefreshToken(String token) {
//        redisTemplate.opsForValue().set("refresh_token:" + token, "blacklisted", Duration.ofSeconds(expirationSeconds));
//    }
//
