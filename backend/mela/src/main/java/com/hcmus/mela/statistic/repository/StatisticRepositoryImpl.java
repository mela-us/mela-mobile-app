...
public class StatisticRepositoryImpl implements StatisticRepository {
     ...
     public List<QuestionStats> getQuestionStats(UUID userId) {
          ...
          AggregationResults<QuestionStats> result = mongoTemplate.aggregate(aggregation, "exercise_results", QuestionStats.class);
     ...
     public List<DailyQuestionStats> getDailyQuestionStatsLast7Days(UUID userId) {
          ...
          Aggregation aggregation = Aggregation.newAggregation(
                  ...
                  Aggregation.project("end_at")
                          .andExpression("dateToString({'format': '%Y-%m-%d', 'date': '$date_time'})").as("date")
