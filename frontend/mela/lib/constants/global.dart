...
class Global {
  ...
  //     Progress(topicName: 'Số học', levelName: 'Trung học', totalCorrect: 3, total: 10),
  //     Progress(topicName: 'Đại số', levelName: 'Trung học', totalCorrect: 3, total: 10),
  //     Progress(topicName: 'Hình học', levelName: 'Tiểu học', totalCorrect: 6, total: 10),
  //     Progress(topicName: 'Lý thuyết số', levelName: 'Phổ thông', totalCorrect: 6, total: 10),
  //     Progress(topicName: 'Xác suất thống kê', levelName: 'Phổ thông', totalCorrect: 6, total: 10),
  //     Progress(topicName: 'Vị phần', levelName: 'Phổ thông', totalCorrect: 5, total: 10),
  //     Progress(topicName: 'Dãy số', levelName: 'Phổ thông', totalCorrect: 5, total: 10),
  // ];

  // static List<DetailedProgress> detailedProgressList = [
  //   DetailedProgress(topicName: 'Số học', levelName: 'Trung học', date: '10/11/2024', count: 2),
  //   DetailedProgress(topicName: 'Số học', levelName: 'Trung học', date: '15/11/2024', count: 1),
  //   DetailedProgress(topicName: 'Số học', levelName: 'Trung học', date: '21/11/2024', count: 1),
  //   DetailedProgress(topicName: 'Số học', levelName: 'Trung học', date: '11/11/2024', count: 2),
  // ];
