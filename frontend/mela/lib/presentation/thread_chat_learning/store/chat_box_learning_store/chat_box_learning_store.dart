...
part 'chat_box_learning_store.g.dart';

class ChatBoxLearningStore = _ChatBoxLearningStore with _$ChatBoxLearningStore;

abstract class _ChatBoxLearningStore with Store {
  _ChatBoxLearningStore() {}
