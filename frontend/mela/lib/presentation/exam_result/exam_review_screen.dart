...
class ExamReviewScreen extends StatefulWidget {
  ExamReviewScreen({super.key});

  @override
  State<ExamReviewScreen> createState() => _ReviewScreenState();
}

class _ReviewScreenState extends State<ExamReviewScreen> {
  final ExamStore _questionStore = getIt<ExamStore>();
  final SingleExamStore _singleQuestionStore = getIt<SingleExamStore>();
  late List<ExamQuestionModel> questions;
  ...
  bool isAnswerCorrect(ExamQuestionModel question, String answer) {
  ...
  AnswerStatus getStatus(ExamQuestionModel q, String a) {
