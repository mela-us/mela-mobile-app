...
class MarkdownContentConverter extends StatelessWidget {
  final String rawText;

  const MarkdownContentConverter({
        ...
        Container(
          ...
          child: MarkdownBody(
            ...
            MarkdownStyleSheet.fromTheme(Theme.of(context)).copyWith(
              p: Theme.of(context).textTheme.miniCaption.copyWith(
                fontSize: 13,
                color: const Color(0xff5D3891),
              ),
              strong: Theme.of(context).textTheme.miniCaption.copyWith(
                fontSize: 13,
                fontWeight: FontWeight.bold,
                color: const Color(0xff5D3891),
              ),
              em: Theme.of(context).textTheme.miniCaption.copyWith(
                fontSize: 13,
